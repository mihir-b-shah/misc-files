...
'''
theta, useless_plot = softmax_regression(train_pca, train_y, temp_parameter=1, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
...
train_x_centered, feature_means_train = center_data(train_x)
...
train_pca10 = project_onto_PC(train_x_centered, pcs_train, 10, feature_means_train)
test_pca10 = project_onto_PC(test_x_centered, pcs_test, 10, feature_means_test)
train_cube = cubic_features(train_pca10)
test_cube = cubic_features(test_pca10)
theta, useless_plot = softmax_regression(train_cube, train_y, temp_parameter=0.999, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
test_error = compute_test_error(test_cube, test_y, theta, temp_parameter=0.999)
print(test_error)
